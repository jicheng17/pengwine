<?php /* Smarty version Smarty-3.1.8, created on 2014-05-13 09:41:23
         compiled from "/var/www/prestashop/themes/theme504/pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15609716435371be934c5998-66200329%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0551fe45de1882a8cb57972be4fd821dbedabf87' => 
    array (
      0 => '/var/www/prestashop/themes/theme504/pagination.tpl',
      1 => 1399798727,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15609716435371be934c5998-66200329',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5371be93603237_61010521',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5371be93603237_61010521')) {function content_5371be93603237_61010521($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/prestashop/tools/smarty/plugins/modifier.escape.php';
...
"><span>&laquo;&nbsp;</span><?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</a></li>
		<?php }else{ ?>
			<li id="pagination_previous" class="disabled"><span>&laquo;&nbsp;</span><?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</li>
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['start']->value==3){?>
			<li><a class="bordercolor" <?php echo $_smarty_tpl->tpl_vars['no_follow_text']->value;?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('smarty')->value['section']['pagination']['index'], 'htmlall', 'UTF-8');?>
		...
		<?php if ($_smarty_tpl->tpl_vars['pages_nb']->value>$_smarty_tpl->tpl_vars['stop']->value+2){?>
			<li class="truncate">...</li>
			<li><a class="bordercolor" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->goPage($_smarty_tpl->tpl_vars['requestPage']->value,$_smarty_tpl->tpl_vars['pages_nb']->value);?>
...
"><?php echo intval($_smarty_tpl->tpl_vars['pages_nb']->value);?>
		...
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['pages_nb']->value==$_smarty_tpl->tpl_vars['stop']->value+2){?>
			<li><a class="bordercolor" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->goPage($_smarty_tpl->tpl_vars['requestPage']->value,$_smarty_tpl->tpl_vars['pages_nb']->value-1);?>
...
<span>&nbsp;&raquo;</span></a></li>
		<?php }else{ ?>
			<li id="pagination_next" class="disabled"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
<span>&nbsp;&raquo;</span></li>
		<?php }?>
		</ul>
