	...
	<table id="cart_summary" class="std">
		...
		<tfoot>
			...
			<tr class="cart_total_voucher" {if $total_discounts == 0}style="display: none;"{/if}>
				...
				{if $use_taxes}
					{if $priceDisplay}
						{if $display_tax_label}{l s='Total discount (tax excl.):'}{else}{l s='Total discount:'}{/if}
					{else}
						{if $display_tax_label}{l s='Total discount (tax incl.):'}{else}{l s='Total discount:'}{/if}
					{/if}
				{else}
					{l s='Total discount:'}
				{/if}
			...
			<tr class="cart_total_price">
				...
				<td colspan="2" class="price total_price_container" id="total_price_container">{l s='Total:'}&nbsp;{displayPrice price=$total_price}</td>
			</tr>
			{else}
			<tr class="cart_total_price">
				<td colspan="5" id="cart_voucher" class="cart_voucher">
